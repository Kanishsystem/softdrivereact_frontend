                ...
                <div className="card">
                    <div className="card-content">
                        <p className="title is-size-4">
                            ...
                            <span className=''>Share "Brand Guideline"</span>
                        ...
                        <div className='General_access pt-3'>General access</div>
                        <div className='is-flex'>
                            ...
                            <div className='sellecternormal pt-5'>
                                <SmartSoftSelect placeHolder='Restricted' /></div>
                        </div>
                        ...
                        <div className='is-flex is-justify-content-space-between p-2'>
                            <span>
                                <button className="button is-link is-light"><i className="fa fa-link pr-2" aria-hidden="true"></i>Copy link</button>
                            </span>
                            <span>
